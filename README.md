...
Практическое задание 2. Использование языка PHP

Инструкция:

Шаг 1. При входе на страницу запишите в куку с именем test текст '123'. Затем обновите страницу и выведите содержимое этой куки на экран. Пример по ссылке - 
